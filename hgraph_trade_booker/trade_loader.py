...
# Example usage
file_path = "/Users/simonkelly/Documents/GitHub/hgraph_platform_tools/test_trades/fixed_float_BM_swap_001.txt"
trade_data = load_trade_from_file(file_path)

# Print loaded trade data to verify
print(json.dumps(trade_data, indent=4))