                ...
                "relativePaymentDates": {
                    ...
                    "paymentDaysOffset": {
                        ...
                        "businessDayConvention": fpml_data.get(
                            f"{leg_prefix}.paymentDaysOffset.businessDayConvention", "NONE"
                        ),
                    },
                    "businessCenters": {"businessCenter": fpml_data.get(f"{leg_prefix}.businessCenters", [])},
                }
            }
        return {}
    ...
    if sub_instrument_type == "fixedFloat":
        fixed_leg = {
            "fixedLeg": {
                ...
                "calculationPeriodsScheduleReference": {
                    "href": fpml_data.get("fixedLeg.calculationPeriodsScheduleReference", "")
                },
                "fixedPrice": {
...
def main() -> None:
    ...
    mapped_instrument, mapped_sub_instrument = map_pricing_instrument(trade_data.get("sub_instrument", ""))
